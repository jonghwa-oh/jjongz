...
public final class Dbms implements Comparable<Dbms> {
  ...
  private final static List<Pair<Pattern, Dbms>> ourDetectors = new CopyOnWriteArrayList<>();
  ...
  public static final Dbms HANA = create("HANA", "HANA", AllIcons.Providers.HANA, defaultPattern("sap|hana"));
  ...
  public static final Dbms IMPALA = create("Impala", DatabaseIcons.DriverBlue1);
  public static final Dbms NETEZZA = create("Netezza", DatabaseIcons.DriverGreen2);
  public static final Dbms PHOENIX = create("Phoenix", DatabaseIcons.DriverPink3);
  ...
  public static final Dbms OPENEDGE = create("OpenEdge", DatabaseIcons.DriverBlue2);
  public static final Dbms TIBERO = create("Tibero", DatabaseIcons.DriverBlue1);
  ...
  public static final Dbms BIGQUERY = create("BIGQUERY", "BigQuery", DatabaseIcons.DriverBlue4);
  ...
  public boolean isMysql() { return this == MYSQL || this == MARIA || this == MEMSQL || this == GITBASE; }
  public boolean isPostgres() { return this == POSTGRES || this == REDSHIFT || this == GREENPLUM || this == COCKROACH; }
  public boolean isRedshift() { return this == REDSHIFT; }
  public boolean isGreenplum() { return this == GREENPLUM; }
  ...
  public boolean isDb2() { return this == DB2_LUW || this == DB2_IS || this == DB2_ZOS || this == DB2; }
  ...
  public boolean isHive() { return this == HIVE; }
  public boolean isSpark() { return this == SPARK; }
  public boolean isSnowflake() { return this == SNOWFLAKE; }
  public boolean isMongo() { return this == MONGO; }
  ...
  private static class LazyData {
    private static final ExtensionPointName<DbmsBean> CONFIG_EP = ExtensionPointName.create("com.intellij.database.dbms");
    static {
